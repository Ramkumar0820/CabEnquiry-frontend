      ...
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start gap-10">
          ...
          <div className="flex flex-col items-center md:items-start w-full md:w-1/3 ">
            <Image src="/logo1.png" className='object-contain rounded-md overflow-hidden' alt="Madurai SRM Tours & Travels" width={120} height={70} />
            <p className="mt-4 text-center md:text-left text-gray-700">
            Book reliable and affordable cab services with Madurai SRM Tours & Travels. Enjoy safe, comfortable rides for local, rental, outstation trips, and hassle-free airport pickup & drop anytime.
            </p>
        ...
        <p className="text-center md:text-left text-sm text-gray-600 mt-8">
          © {currentYear} Madurai SRM Tours & Travels. All rights reserved.
        </p>
      </div>
    </footer>
  );
